...
class AppLocalizationsSr extends AppLocalizations {
  ...
  @override
  String get settingsHeader => 'Podešavanja';

  @override
  String get accountHeader => 'Nalog';

  @override
  String get discoverPremium => 'Istražite Premium';

  @override
  String get unlimitedLeaseContracts => 'Neograničeni najamni ugovori';
  ...
  @override
  String get optional => 'Opciono';

  @override
  String get sentInvitation => 'Poslati poziv';
...
class AppLocalizationsSrCyrl extends AppLocalizationsSr {
  ...
  @override
  String get consentTextFullBody =>
      'Коришћењем апликације Станомер, дајете изричит пристанак за обраду ваших података о личности у складу са Законом о заштити података о личности (ЗЗПЛ) Републике Србије.\n\nКоји подаци се прикупљају: Ваше име, е-маил адреса, ИП адреса и подаци из уговора о закупу непокретности.\n\nСврха обраде: Подаци се користе искључиво за олакшавање комуникације између станодавца и закупаца, вођење евиденције о плаћању и креирање правно ваљаних записа.\n\nДељење података: Ваши подаци се не продају трећим лицима. Чувају се на сигурним серверима у ЕУ (Супабасе Франкфурт).\n\nВаша права: Имате право да у било ком тренутку затражите приступ својим подацима или трајно брисање вашег налога и свих повезаних података директно путем апликације.';
  ...
  @override
  String get totalRentShort => 'Кира';
  ...
  @override
  String get leaseLockedWarning =>
      'Постојец́и договорени услови закупа (закупнина, датуми и трошкови) ц́е се примењивати и на овог закупца.';
  ...
  @override
  String get downloadOnPlayStore => 'Преузми на Гоогле Плаy-у';

  @override
  String get premiumFeatures => 'Премиум функције';
  ...
  @override
  String get errorSendingMessage =>
      'Слање поруке није успело. Молимо покушајте поново.';
  ...
  @override
  String get offlineMessage =>
      'Тренутно сте ван мреже. Можете наставити са постојећим подацима. Биће ажурирано када се повежете.';
  ...
  @override
  String get sentInvitation => 'Послати позив';
