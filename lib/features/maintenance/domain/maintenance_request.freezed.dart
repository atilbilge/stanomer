...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,propertyId,contractId,reporterId,title,category,description,status,priority,const DeepCollectionEquality().hash(photosUrls),costAmount,currency,paidBy,paymentDate,paymentStatus,invoicePdfUrl,createdAt,updatedAt);

@override
String toString() {
  return 'MaintenanceRequest(id: $id, propertyId: $propertyId, contractId: $contractId, reporterId: $reporterId, title: $title, category: $category, description: $description, status: $status, priority: $priority, photosUrls: $photosUrls, costAmount: $costAmount, currency: $currency, paidBy: $paidBy, paymentDate: $paymentDate, paymentStatus: $paymentStatus, invoicePdfUrl: $invoicePdfUrl, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,propertyId,contractId,reporterId,title,category,description,status,priority,const DeepCollectionEquality().hash(_photosUrls),costAmount,currency,paidBy,paymentDate,paymentStatus,invoicePdfUrl,createdAt,updatedAt);
