...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,propertyId,contractId,reporterId,title,category,description,status,priority,const DeepCollectionEquality().hash(photosUrls),costAmount,settledAmount,currency,paidBy,paymentDate,paymentStatus,invoicePdfUrl,rejectionReason,rejectedBy,createdAt,updatedAt]);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,propertyId,contractId,reporterId,title,category,description,status,priority,const DeepCollectionEquality().hash(_photosUrls),costAmount,settledAmount,currency,paidBy,paymentDate,paymentStatus,invoicePdfUrl,rejectionReason,rejectedBy,createdAt,updatedAt]);
