...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,propertyId,contractId,tenantId,amount,currency,dueDate,status,receiptUrl,invoiceUrl,declaredAt,paidAt,disputeReason,disputedAt,ownerNote,title,receiverType,paymentMethod,createdAt]);

@override
String toString() {
  return 'RentPayment(id: $id, propertyId: $propertyId, contractId: $contractId, tenantId: $tenantId, amount: $amount, currency: $currency, dueDate: $dueDate, status: $status, receiptUrl: $receiptUrl, invoiceUrl: $invoiceUrl, declaredAt: $declaredAt, paidAt: $paidAt, disputeReason: $disputeReason, disputedAt: $disputedAt, ownerNote: $ownerNote, title: $title, receiverType: $receiverType, paymentMethod: $paymentMethod, createdAt: $createdAt)';
}
...
switch (_that) {
case _RentPayment() when $default != null:
return $default(_that.id,_that.propertyId,_that.contractId,_that.tenantId,_that.amount,_that.currency,_that.dueDate,_that.status,_that.receiptUrl,_that.invoiceUrl,_that.declaredAt,_that.paidAt,_that.disputeReason,_that.disputedAt,_that.ownerNote,_that.title,_that.receiverType,_that.paymentMethod,_that.createdAt);case _:
  return orElse();
