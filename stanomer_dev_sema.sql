...
--\restrict 461ZfxwcrIIMPc3DqEVxIpEgAPILRHrnOCcpGqD52x0FciBokT9DH99IRN8Rsg8
...
--
-- Name: accept_contract(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.accept_contract(contract_token text) OWNER TO postgres;
...
ALTER FUNCTION public.accept_invitation(p_invite_token text) OWNER TO postgres;

--
-- Name: accept_proposed_changes(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.accept_proposed_changes(p_contract_id uuid) OWNER TO postgres;

--
-- Name: check_is_landlord_of_property(uuid, uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.check_is_landlord_of_property(p_id uuid, u_id uuid) OWNER TO postgres;

--
-- Name: check_is_tenant_of_property(uuid, uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.check_is_tenant_of_property(p_id uuid, u_id uuid) OWNER TO postgres;

--
-- Name: decline_proposed_changes(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.decline_proposed_changes(p_contract_id uuid) OWNER TO postgres;

--
-- Name: delete_old_notifications(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: generate_missing_rent_payments(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.generate_missing_rent_payments(p_property_id uuid) OWNER TO postgres;
...
--
-- Name: leave_property(uuid, uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.leave_property(p_property_id uuid, p_invite_id uuid) OWNER TO postgres;

--
-- Name: propose_contract_changes(uuid, jsonb); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.propose_contract_changes(p_contract_id uuid, p_changes jsonb) OWNER TO postgres;

--
-- Name: propose_contract_termination(uuid, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.propose_contract_termination(p_contract_id uuid, p_termination_date timestamp with time zone) OWNER TO postgres;
...
CREATE TABLE public.contracts (
    ...
    tax_type public.tax_type DEFAULT 'included'::public.tax_type,
    contract_url text,
    proposed_changes jsonb,
    proposed_by uuid,
    additional_documents jsonb DEFAULT '[]'::jsonb,
    termination_approved boolean DEFAULT false,
    deposit_currency text DEFAULT 'EUR'::text
);
...
--
-- Name: maintenance_messages; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.maintenance_messages OWNER TO postgres;
...
CREATE TABLE public.maintenance_requests (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT maintenance_requests_priority_check CHECK ((priority = ANY (ARRAY['normal'::text, 'urgent'::text]))),
    CONSTRAINT maintenance_requests_status_check CHECK ((status = ANY (ARRAY['open'::text, 'investigating'::text, 'resolved'::text])))
);
...
--
-- Name: payments_temp; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.payments_temp (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    lease_id uuid,
    payment_type text,
    ...
    receipt_url text,
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT payments_payment_type_check CHECK ((payment_type = ANY (ARRAY['rent'::text, 'utility'::text, 'deposit'::text]))),
    CONSTRAINT payments_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'paid'::text, 'partial'::text])))
);


ALTER TABLE public.payments_temp OWNER TO postgres;
...
CREATE TABLE public.profiles (
    ...
    zzpl_consent boolean DEFAULT false,
    created_at timestamp with time zone DEFAULT now(),
    email text,
    updated_at timestamp with time zone DEFAULT now(),
...
CREATE TABLE public.properties (
    ...
    default_monthly_rent numeric NOT NULL,
    default_deposit_amount numeric,
    utility_config jsonb,
    created_at timestamp with time zone DEFAULT now(),
    ...
    tax_type public.tax_type DEFAULT 'included'::public.tax_type,
    default_deposit_currency text DEFAULT 'EUR'::text,
    CONSTRAINT properties_currency_check CHECK ((currency = ANY (ARRAY['EUR'::text, 'RSD'::text]))),
    CONSTRAINT properties_default_currency_check CHECK ((default_currency = ANY (ARRAY['EUR'::text, 'RSD'::text]))),
    CONSTRAINT properties_due_day_check CHECK (((default_due_day >= 1) AND (default_due_day <= 31)))
);
...
--
-- Name: properties_with_names; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.properties_with_names WITH (security_invoker='on') AS
 SELECT p.id,
    p.landlord_id,
    p.address,
    p.default_currency,
    ...
    p.expenses_template,
    p.tax_type,
    COALESCE(lp.full_name, ( SELECT contracts.inviter_name
           FROM public.contracts
          WHERE ((contracts.property_id = p.id) AND (contracts.status = 'active'::public.contract_status))
         LIMIT 1), 'Landlord'::text) AS landlord_name,
    COALESCE(tp.full_name, ( SELECT contracts.invitee_email
           FROM public.contracts
          WHERE ((contracts.property_id = p.id) AND (contracts.status = 'active'::public.contract_status))
         LIMIT 1), 'Tenant'::text) AS tenant_name
   FROM ((public.properties p
     LEFT JOIN public.profiles lp ON ((p.landlord_id = lp.id)))
     LEFT JOIN public.profiles tp ON ((p.tenant_id = tp.id)));


ALTER VIEW public.properties_with_names OWNER TO postgres;
...
CREATE TABLE public.rent_payments (
    ...
    receipt_url text,
    title text DEFAULT 'Kira'::text NOT NULL,
    receiver_type text DEFAULT 'owner'::text,
    invoice_url text,
    contract_id uuid,
    dispute_reason text,
...
--
-- Name: transaction_logs_temp; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.transaction_logs_temp (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    lease_id uuid,
    action_type text,
    ip_address text,
...
ALTER TABLE public.transaction_logs_temp OWNER TO postgres;
...
--
-- Name: utility_bills_temp; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.utility_bills_temp (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    lease_id uuid,
    utility_type text,
    amount numeric NOT NULL,
    ...
    invoice_url text,
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT utility_bills_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'paid'::text, 'overdue'::text]))),
    CONSTRAINT utility_bills_utility_type_check CHECK ((utility_type = ANY (ARRAY['electricity'::text, 'water'::text, 'internet'::text, 'other'::text])))
);


ALTER TABLE public.utility_bills_temp OWNER TO postgres;
...
--
-- Name: messages_2026_07_28; Type: TABLE; Schema: realtime; Owner: supabase_realtime_admin
--
...
ALTER TABLE realtime.messages_2026_07_28 OWNER TO supabase_realtime_admin;

--
-- Name: messages_2026_07_29; Type: TABLE; Schema: realtime; Owner: supabase_realtime_admin
--
...
ALTER TABLE realtime.messages_2026_07_29 OWNER TO supabase_realtime_admin;

--
-- Name: messages_2026_07_30; Type: TABLE; Schema: realtime; Owner: supabase_realtime_admin
--
...
ALTER TABLE realtime.messages_2026_07_30 OWNER TO supabase_realtime_admin;
...
--
-- Name: messages_2026_07_28; Type: TABLE ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2026_07_29; Type: TABLE ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2026_07_30; Type: TABLE ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: contracts contracts_token_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: leases leases_invitation_token_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.leases
    ADD CONSTRAINT leases_invitation_token_key UNIQUE (invitation_token);
...
--
-- Name: maintenance_messages maintenance_messages_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: payments_temp payments_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.payments_temp
...
--
-- Name: rent_payments rent_payments_contract_due_date_title_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.rent_payments
    ADD CONSTRAINT rent_payments_contract_due_date_title_key UNIQUE NULLS NOT DISTINCT (contract_id, due_date, title);
...
--
-- Name: transaction_logs_temp transaction_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.transaction_logs_temp
...
--
-- Name: utility_bills_temp utility_bills_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.utility_bills_temp
...
--
-- Name: messages_2026_07_28 messages_2026_07_28_pkey; Type: CONSTRAINT; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2026_07_29 messages_2026_07_29_pkey; Type: CONSTRAINT; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2026_07_30 messages_2026_07_30_pkey; Type: CONSTRAINT; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2026_07_28_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2026_07_29_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2026_07_30_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2026_07_28_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2026_07_28_pkey; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: contracts set_contracts_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: activity_logs activity_logs_property_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: contracts contracts_landlord_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.contracts
    ADD CONSTRAINT contracts_landlord_id_fkey FOREIGN KEY (landlord_id) REFERENCES auth.users(id);
...
--
-- Name: contracts contracts_proposed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.contracts
    ADD CONSTRAINT contracts_proposed_by_fkey FOREIGN KEY (proposed_by) REFERENCES auth.users(id);
...
ALTER TABLE ONLY public.contracts
    ADD CONSTRAINT contracts_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES auth.users(id);
...
--
-- Name: invitations invitations_property_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: maintenance_messages maintenance_messages_request_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.maintenance_messages
    ADD CONSTRAINT maintenance_messages_request_id_fkey FOREIGN KEY (request_id) REFERENCES public.maintenance_requests(id) ON DELETE CASCADE;


--
-- Name: maintenance_messages maintenance_messages_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.maintenance_messages
    ADD CONSTRAINT maintenance_messages_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE;


--
-- Name: maintenance_requests maintenance_requests_contract_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.maintenance_requests
    ADD CONSTRAINT maintenance_requests_contract_id_fkey FOREIGN KEY (contract_id) REFERENCES public.contracts(id);


--
-- Name: maintenance_requests maintenance_requests_property_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: maintenance_requests maintenance_requests_reporter_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.maintenance_requests
    ADD CONSTRAINT maintenance_requests_reporter_id_fkey FOREIGN KEY (reporter_id) REFERENCES auth.users(id);
...
--
-- Name: payments_temp payments_lease_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES auth.users(id);


--
-- Name: rent_payments rent_payments_contract_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.rent_payments
    ADD CONSTRAINT rent_payments_contract_id_fkey FOREIGN KEY (contract_id) REFERENCES public.contracts(id) ON DELETE SET NULL;


--
-- Name: rent_payments rent_payments_property_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.rent_payments
    ADD CONSTRAINT rent_payments_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.profiles(id) ON DELETE SET NULL;


--
-- Name: transaction_logs_temp transaction_logs_lease_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.transaction_logs_temp
    ADD CONSTRAINT transaction_logs_lease_id_fkey FOREIGN KEY (lease_id) REFERENCES public.leases(id) ON DELETE CASCADE;
...
--
-- Name: utility_bills_temp utility_bills_lease_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.utility_bills_temp
    ADD CONSTRAINT utility_bills_lease_id_fkey FOREIGN KEY (lease_id) REFERENCES public.leases(id) ON DELETE CASCADE;


--
-- Name: utility_bills_temp utility_bills_payer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.utility_bills_temp
    ADD CONSTRAINT utility_bills_payer_id_fkey FOREIGN KEY (payer_id) REFERENCES public.profiles(id);
...
--
-- Name: profiles Authenticated users can see all profiles; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: invitations Invitees can update their own invitations; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Invitees can update their own invitations" ON public.invitations FOR UPDATE USING ((auth.email() = invitee_email));


--
-- Name: properties Invitees can view property details; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Invitees can view property details" ON public.properties FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.invitations
  WHERE ((invitations.property_id = properties.id) AND (invitations.invitee_email = auth.email()) AND (invitations.status = 'pending'::text)))));


--
-- Name: user_consents Kullanıcılar kendi ZZPL onaylarını okuyabilir; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Kullanıcılar kendi ZZPL onaylarını okuyabilir" ON public.user_consents FOR SELECT TO authenticated USING ((auth.uid() = user_id));


--
-- Name: profiles Kullanıcılar kendi profilini görebilir; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Kullanıcılar kendi profilini görebilir" ON public.profiles FOR SELECT USING ((auth.uid() = id));


--
-- Name: profiles Kullanıcılar kendi profilini güncelleyebilir; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: invitations Owners can create invitations; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Owners can create invitations" ON public.invitations FOR INSERT WITH CHECK ((auth.uid() = inviter_id));


--
-- Name: invitations Owners can delete their invitations; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Owners can delete their invitations" ON public.invitations FOR DELETE USING ((auth.uid() = inviter_id));


--
-- Name: properties Owners can delete their own properties; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Owners can delete their own properties" ON public.properties FOR DELETE USING ((auth.uid() = landlord_id));


--
-- Name: properties Owners can insert their own properties; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Owners can insert their own properties" ON public.properties FOR INSERT WITH CHECK ((auth.uid() = landlord_id));


--
-- Name: properties Owners can select their own properties; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Owners can select their own properties" ON public.properties FOR SELECT USING ((auth.uid() = landlord_id));


--
-- Name: invitations Owners can update their invitations; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Owners can update their invitations" ON public.invitations FOR UPDATE USING ((auth.uid() = inviter_id));


--
-- Name: properties Owners can update their own properties; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Owners can update their own properties" ON public.properties FOR UPDATE USING ((auth.uid() = landlord_id)) WITH CHECK ((auth.uid() = landlord_id));


--
-- Name: invitations Owners can view their invitations; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Owners can view their invitations" ON public.invitations FOR SELECT USING (((auth.uid() = inviter_id) OR (auth.email() = invitee_email)));


--
-- Name: maintenance_requests Participants can update maintenance requests; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Participants can update maintenance requests" ON public.maintenance_requests FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM public.properties p
  WHERE ((p.id = maintenance_requests.property_id) AND ((p.landlord_id = auth.uid()) OR (p.tenant_id = auth.uid()))))));


--
-- Name: maintenance_requests Participants can view maintenance requests; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Participants can view maintenance requests" ON public.maintenance_requests FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.properties p
  WHERE ((p.id = maintenance_requests.property_id) AND ((p.landlord_id = auth.uid()) OR (p.tenant_id = auth.uid()))))));


--
-- Name: maintenance_requests Tenants can create maintenance requests; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Tenants can create maintenance requests" ON public.maintenance_requests FOR INSERT WITH CHECK (((EXISTS ( SELECT 1
   FROM public.properties p
  WHERE ((p.id = maintenance_requests.property_id) AND (p.tenant_id = auth.uid())))) AND (reporter_id = auth.uid())));


--
-- Name: properties Tenants can view properties they are assigned to; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Tenants can view properties they are assigned to" ON public.properties FOR SELECT USING ((auth.uid() = tenant_id));


--
-- Name: maintenance_requests Users can delete maintenance requests; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can delete maintenance requests" ON public.maintenance_requests FOR DELETE USING ((reporter_id = auth.uid()));
...
--
-- Name: maintenance_messages Users can insert maintenance messages; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can insert maintenance messages" ON public.maintenance_messages FOR INSERT WITH CHECK (((auth.uid() = user_id) AND (EXISTS ( SELECT 1
   FROM (public.maintenance_requests r
     LEFT JOIN public.properties p ON ((p.id = r.property_id)))
  WHERE ((r.id = maintenance_messages.request_id) AND ((r.reporter_id = auth.uid()) OR (p.landlord_id = auth.uid())))))));
...
--
-- Name: maintenance_requests Users can update maintenance requests; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can update maintenance requests" ON public.maintenance_requests FOR UPDATE USING (((reporter_id = auth.uid()) OR (EXISTS ( SELECT 1
   FROM public.properties p
  WHERE ((p.id = maintenance_requests.property_id) AND (p.landlord_id = auth.uid())))))) WITH CHECK (((reporter_id = auth.uid()) OR (EXISTS ( SELECT 1
   FROM public.properties p
...
--
-- Name: maintenance_messages Users can view maintenance messages; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can view maintenance messages" ON public.maintenance_messages FOR SELECT USING ((EXISTS ( SELECT 1
   FROM (public.maintenance_requests r
     LEFT JOIN public.properties p ON ((p.id = r.property_id)))
  WHERE ((r.id = maintenance_messages.request_id) AND ((r.reporter_id = auth.uid()) OR (p.landlord_id = auth.uid()))))));
...
--
-- Name: maintenance_requests Users can view maintenance requests; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can view maintenance requests" ON public.maintenance_requests FOR SELECT USING (((reporter_id = auth.uid()) OR (EXISTS ( SELECT 1
   FROM public.properties p
  WHERE ((p.id = maintenance_requests.property_id) AND (p.landlord_id = auth.uid()))))));
...
CREATE POLICY "Users can view their own leases" ON public.leases FOR SELECT USING (((auth.uid() = tenant_id) OR public.check_is_landlord_of_property(property_id, auth.uid())));
...
--
-- Name: profiles authenticated_select_profiles; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: contracts landlord_manage_contracts; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY landlord_manage_contracts ON public.contracts USING ((auth.uid() = landlord_id));


--
-- Name: invitations landlord_manage_invites; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY landlord_manage_invites ON public.invitations USING ((auth.uid() = inviter_id));


--
-- Name: activity_logs landlord_select_activity_logs; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY landlord_select_activity_logs ON public.activity_logs FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.properties p
  WHERE ((p.id = activity_logs.property_id) AND (p.landlord_id = auth.uid())))));


--
-- Name: invitations landlord_select_invites; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY landlord_select_invites ON public.invitations FOR SELECT USING ((auth.uid() = inviter_id));


--
-- Name: properties landlord_select_properties; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY landlord_select_properties ON public.properties FOR SELECT USING ((auth.uid() = landlord_id));


--
-- Name: rent_payments landlord_select_rent_payments; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY landlord_select_rent_payments ON public.rent_payments FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.properties p
  WHERE ((p.id = rent_payments.property_id) AND (p.landlord_id = auth.uid())))));


--
-- Name: properties landlord_update_properties; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY landlord_update_properties ON public.properties FOR UPDATE USING ((auth.uid() = landlord_id)) WITH CHECK ((auth.uid() = landlord_id));


--
-- Name: rent_payments landlord_update_rent_payments; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY landlord_update_rent_payments ON public.rent_payments FOR UPDATE TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.properties p
  WHERE ((p.id = rent_payments.property_id) AND (p.landlord_id = auth.uid()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.properties p
  WHERE ((p.id = rent_payments.property_id) AND (p.landlord_id = auth.uid())))));
...
--
-- Name: maintenance_messages; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: payments_temp; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: rent_payments; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.rent_payments ENABLE ROW LEVEL SECURITY;

--
-- Name: properties tenant_join_property; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tenant_join_property ON public.properties FOR UPDATE USING ((tenant_id IS NULL)) WITH CHECK ((tenant_id = auth.uid()));


--
-- Name: contracts tenant_respond_contract; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tenant_respond_contract ON public.contracts FOR UPDATE USING (((lower(invitee_email) = lower((auth.jwt() ->> 'email'::text))) OR (tenant_id = auth.uid()) OR ((auth.uid() IS NOT NULL) AND (status = ANY (ARRAY['pending'::public.contract_status, 'negotiating'::public.contract_status])) AND (tenant_id IS NULL)))) WITH CHECK ((status = ANY (ARRAY['pending'::public.contract_status, 'negotiating'::public.contract_status, 'active'::public.contract_status, 'declined'::public.contract_status, 'revision_requested'::public.contract_status])));


--
-- Name: activity_logs tenant_select_activity_logs; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tenant_select_activity_logs ON public.activity_logs FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.properties p
  WHERE ((p.id = activity_logs.property_id) AND (p.tenant_id = auth.uid())))));


--
-- Name: invitations tenant_select_invites; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tenant_select_invites ON public.invitations FOR SELECT USING (((auth.jwt() ->> 'email'::text) = invitee_email));


--
-- Name: properties tenant_select_properties; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tenant_select_properties ON public.properties FOR SELECT USING ((auth.uid() = tenant_id));


--
-- Name: rent_payments tenant_select_rent_payments; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tenant_select_rent_payments ON public.rent_payments FOR SELECT USING (((tenant_id = auth.uid()) OR (EXISTS ( SELECT 1
   FROM public.properties p
  WHERE ((p.id = rent_payments.property_id) AND (p.tenant_id = auth.uid()))))));


--
-- Name: rent_payments tenant_update_rent_payments; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tenant_update_rent_payments ON public.rent_payments FOR UPDATE TO authenticated USING (((tenant_id = auth.uid()) AND (status = 'pending'::text))) WITH CHECK (((tenant_id = auth.uid()) AND (((status = 'declared'::text) AND (declared_at IS NOT NULL)) OR ((status = 'disputed'::text) AND (dispute_reason IS NOT NULL) AND (disputed_at IS NOT NULL)))));


--
-- Name: properties tenant_view_invited_properties; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tenant_view_invited_properties ON public.properties FOR SELECT USING ((id IN ( SELECT contracts.property_id
   FROM public.contracts
  WHERE (((lower(contracts.invitee_email) = lower((auth.jwt() ->> 'email'::text))) OR (contracts.tenant_id = auth.uid())) AND (contracts.status = ANY (ARRAY['pending'::public.contract_status, 'negotiating'::public.contract_status, 'revision_requested'::public.contract_status, 'active'::public.contract_status]))))));


--
-- Name: properties tenant_view_properties; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tenant_view_properties ON public.properties FOR SELECT USING (((auth.uid() = landlord_id) OR (auth.uid() = tenant_id) OR public.check_is_tenant_of_property(id, auth.uid())));


--
-- Name: contracts tenant_view_update_contracts; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tenant_view_update_contracts ON public.contracts FOR SELECT USING (((lower(invitee_email) = lower((auth.jwt() ->> 'email'::text))) OR (tenant_id = auth.uid()) OR ((auth.uid() IS NOT NULL) AND (status = ANY (ARRAY['pending'::public.contract_status, 'negotiating'::public.contract_status])) AND (tenant_id IS NULL))));


--
-- Name: transaction_logs_temp; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.transaction_logs_temp ENABLE ROW LEVEL SECURITY;
...
--
-- Name: activity_logs user_insert_activity_logs; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY user_insert_activity_logs ON public.activity_logs FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM public.properties p
  WHERE ((p.id = activity_logs.property_id) AND ((p.landlord_id = auth.uid()) OR (p.tenant_id = auth.uid()))))));


--
-- Name: utility_bills_temp; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.utility_bills_temp ENABLE ROW LEVEL SECURITY;
...
--
-- Name: objects Allow authenticated users to upload contracts; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Allow authenticated users to upload contracts" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'contracts'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));


--
-- Name: objects Allow authenticated users to upload maintenance photos; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Allow authenticated users to upload maintenance photos" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'maintenance'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));


--
-- Name: objects Allow authenticated users to upload receipts; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Allow authenticated users to upload receipts" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'receipts'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));


--
-- Name: objects Allow public read access to contracts; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Allow public read access to contracts" ON storage.objects FOR SELECT USING ((bucket_id = 'contracts'::text));


--
-- Name: objects Allow public read access to maintenance photos; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Allow public read access to maintenance photos" ON storage.objects FOR SELECT USING ((bucket_id = 'maintenance'::text));


--
-- Name: objects Allow public read access to receipts; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Allow public read access to receipts" ON storage.objects FOR SELECT USING ((bucket_id = 'receipts'::text));


--
-- Name: objects Anyone can view contract files; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Anyone can view contract files" ON storage.objects FOR SELECT USING ((bucket_id = 'contracts'::text));


--
-- Name: objects Landlords can upload contract files; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Landlords can upload contract files" ON storage.objects FOR INSERT TO authenticated WITH CHECK ((bucket_id = 'contracts'::text));
...
--
-- Name: supabase_realtime contracts; Type: PUBLICATION TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: supabase_realtime maintenance_messages; Type: PUBLICATION TABLE; Schema: public; Owner: postgres
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.maintenance_messages;
...
--
-- Name: supabase_realtime properties; Type: PUBLICATION TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: supabase_realtime rent_payments; Type: PUBLICATION TABLE; Schema: public; Owner: postgres
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.rent_payments;
...
--
-- Name: FUNCTION accept_contract(contract_token text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.accept_contract(contract_token text) TO anon;
GRANT ALL ON FUNCTION public.accept_contract(contract_token text) TO authenticated;
GRANT ALL ON FUNCTION public.accept_contract(contract_token text) TO service_role;


--
-- Name: FUNCTION accept_invitation(p_invite_token text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.accept_invitation(p_invite_token text) TO anon;
GRANT ALL ON FUNCTION public.accept_invitation(p_invite_token text) TO authenticated;
GRANT ALL ON FUNCTION public.accept_invitation(p_invite_token text) TO service_role;


--
-- Name: FUNCTION accept_proposed_changes(p_contract_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.accept_proposed_changes(p_contract_id uuid) TO anon;
GRANT ALL ON FUNCTION public.accept_proposed_changes(p_contract_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.accept_proposed_changes(p_contract_id uuid) TO service_role;


--
-- Name: FUNCTION check_is_landlord_of_property(p_id uuid, u_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.check_is_landlord_of_property(p_id uuid, u_id uuid) TO anon;
GRANT ALL ON FUNCTION public.check_is_landlord_of_property(p_id uuid, u_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.check_is_landlord_of_property(p_id uuid, u_id uuid) TO service_role;


--
-- Name: FUNCTION check_is_tenant_of_property(p_id uuid, u_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.check_is_tenant_of_property(p_id uuid, u_id uuid) TO anon;
GRANT ALL ON FUNCTION public.check_is_tenant_of_property(p_id uuid, u_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.check_is_tenant_of_property(p_id uuid, u_id uuid) TO service_role;


--
-- Name: FUNCTION decline_proposed_changes(p_contract_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.decline_proposed_changes(p_contract_id uuid) TO anon;
GRANT ALL ON FUNCTION public.decline_proposed_changes(p_contract_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.decline_proposed_changes(p_contract_id uuid) TO service_role;


--
-- Name: FUNCTION delete_old_notifications(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION generate_missing_rent_payments(p_property_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.generate_missing_rent_payments(p_property_id uuid) TO anon;
GRANT ALL ON FUNCTION public.generate_missing_rent_payments(p_property_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.generate_missing_rent_payments(p_property_id uuid) TO service_role;
...
--
-- Name: FUNCTION leave_property(p_property_id uuid, p_invite_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.leave_property(p_property_id uuid, p_invite_id uuid) TO anon;
GRANT ALL ON FUNCTION public.leave_property(p_property_id uuid, p_invite_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.leave_property(p_property_id uuid, p_invite_id uuid) TO service_role;


--
-- Name: FUNCTION propose_contract_changes(p_contract_id uuid, p_changes jsonb); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.propose_contract_changes(p_contract_id uuid, p_changes jsonb) TO anon;
GRANT ALL ON FUNCTION public.propose_contract_changes(p_contract_id uuid, p_changes jsonb) TO authenticated;
GRANT ALL ON FUNCTION public.propose_contract_changes(p_contract_id uuid, p_changes jsonb) TO service_role;


--
-- Name: FUNCTION propose_contract_termination(p_contract_id uuid, p_termination_date timestamp with time zone); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.propose_contract_termination(p_contract_id uuid, p_termination_date timestamp with time zone) TO anon;
GRANT ALL ON FUNCTION public.propose_contract_termination(p_contract_id uuid, p_termination_date timestamp with time zone) TO authenticated;
GRANT ALL ON FUNCTION public.propose_contract_termination(p_contract_id uuid, p_termination_date timestamp with time zone) TO service_role;
...
--
-- Name: TABLE maintenance_messages; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.maintenance_messages TO anon;
GRANT ALL ON TABLE public.maintenance_messages TO authenticated;
GRANT ALL ON TABLE public.maintenance_messages TO service_role;
...
--
-- Name: TABLE payments_temp; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.payments_temp TO anon;
GRANT ALL ON TABLE public.payments_temp TO authenticated;
GRANT ALL ON TABLE public.payments_temp TO service_role;
...
--
-- Name: TABLE properties_with_names; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.properties_with_names TO anon;
GRANT ALL ON TABLE public.properties_with_names TO authenticated;
GRANT ALL ON TABLE public.properties_with_names TO service_role;


--
-- Name: TABLE rent_payments; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE transaction_logs_temp; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.transaction_logs_temp TO anon;
GRANT ALL ON TABLE public.transaction_logs_temp TO authenticated;
GRANT ALL ON TABLE public.transaction_logs_temp TO service_role;
...
--
-- Name: TABLE utility_bills_temp; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.utility_bills_temp TO anon;
GRANT ALL ON TABLE public.utility_bills_temp TO authenticated;
GRANT ALL ON TABLE public.utility_bills_temp TO service_role;
...
--
-- Name: TABLE messages_2026_07_28; Type: ACL; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: TABLE messages_2026_07_29; Type: ACL; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: TABLE messages_2026_07_30; Type: ACL; Schema: realtime; Owner: supabase_realtime_admin
--
...
-- \unrestrict 461ZfxwcrIIMPc3DqEVxIpEgAPILRHrnOCcpGqD52x0FciBokT9DH99IRN8Rsg8
