...
export default function AgencyDemoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If running on Localhost, Vercel Preview domain, or any domain other than production (stanomer.online), FORCE Dev DB!
      if (typeof window !== "undefined") {
        const isProductionDomain = window.location.hostname === "stanomer.online" || window.location.hostname === "www.stanomer.online";
